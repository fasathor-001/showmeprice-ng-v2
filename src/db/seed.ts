...
async function seed() {
  ...
  await db
    ...
    .values([
      { name: "Abia", iso_code: "NG-AB" },
      { name: "Adamawa", iso_code: "NG-AD" },
      { name: "Akwa Ibom", iso_code: "NG-AK" },
      { name: "Anambra", iso_code: "NG-AN" },
      { name: "Bauchi", iso_code: "NG-BA" },
      { name: "Bayelsa", iso_code: "NG-BY" },
      { name: "Benue", iso_code: "NG-BE" },
      { name: "Borno", iso_code: "NG-BO" },
      { name: "Cross River", iso_code: "NG-CR" },
      { name: "Delta", iso_code: "NG-DE" },
      { name: "Ebonyi", iso_code: "NG-EB" },
      { name: "Edo", iso_code: "NG-ED" },
      { name: "Ekiti", iso_code: "NG-EK" },
      { name: "Enugu", iso_code: "NG-EN" },
      { name: "Federal Capital Territory", iso_code: "NG-FC" },
      { name: "Gombe", iso_code: "NG-GO" },
      { name: "Imo", iso_code: "NG-IM" },
      { name: "Jigawa", iso_code: "NG-JI" },
      { name: "Kaduna", iso_code: "NG-KD" },
      { name: "Kano", iso_code: "NG-KN" },
      { name: "Katsina", iso_code: "NG-KT" },
      { name: "Kebbi", iso_code: "NG-KE" },
      { name: "Kogi", iso_code: "NG-KO" },
      { name: "Kwara", iso_code: "NG-KW" },
      { name: "Lagos", iso_code: "NG-LA" },
      { name: "Nasarawa", iso_code: "NG-NA" },
      { name: "Niger", iso_code: "NG-NI" },
      { name: "Ogun", iso_code: "NG-OG" },
      { name: "Ondo", iso_code: "NG-ON" },
      { name: "Osun", iso_code: "NG-OS" },
      { name: "Oyo", iso_code: "NG-OY" },
      { name: "Plateau", iso_code: "NG-PL" },
      { name: "Rivers", iso_code: "NG-RI" },
      { name: "Sokoto", iso_code: "NG-SO" },
      { name: "Taraba", iso_code: "NG-TA" },
      { name: "Yobe", iso_code: "NG-YO" },
      { name: "Zamfara", iso_code: "NG-ZA" },
    ])
    .onConflictDoNothing();

...
// Stage 2.C Commit 9-a — TC-001 / K-045 image-message attachments.
// Path structure: message-images/{conversation_id}/{message_id}/{position}-{ts}.jpg
// — see migrations/E.2.9.1-message-images-recreate.sql.
//
// Drizzle is schema-mirror only on this codebase (runtime uses Supabase
// JS); this file exists to keep the mirror in lockstep with the deployed
// schema for type inference + future tooling.
